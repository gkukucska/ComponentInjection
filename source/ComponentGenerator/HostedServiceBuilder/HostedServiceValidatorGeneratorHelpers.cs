...
{
    internal static class HostedServiceValidatorGeneratorHelpers
    {
        internal static void GenerateComponentBuilderSyntax(SourceProductionContext context, HostedServiceModel model)
        {
